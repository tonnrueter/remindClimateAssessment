...
R package **remindClimateAssessment**, version **0.1.4**
...
Rüter T (2026). "remindClimateAssessment: REMIND integration of IIASA's `climate-assessment` package." Version: 0.1.4, <https://github.com/pik-piam/remindClimateAssessment>.
